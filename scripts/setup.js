...
function printInstructions(authToken) {
  ...
  console.log('   - Copy the bot token to TELEGRAM_BOT_TOKEN in .env');
  console.log('');
  console.log('2. Get your Telegram chat ID:');
  console.log('   - Message @userinfobot on Telegram');
  console.log('   - Copy your numeric ID to TELEGRAM_CHAT_ID in .env');
  console.log('');
  console.log('3. Start the server:');
  console.log('   npm run dev');
  console.log('');
  console.log('4. Configure Claude Code hook:');
